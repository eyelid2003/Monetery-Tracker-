...
<head>
    ...
    <style>
        ...
        /* Income Cards and Create Income Box */
        .income-card, .create-income {
        ...
        .income-card:hover, .create-income:hover {
...
<body>
    ...
    <main class="content">
        <header>
            <h2>Welcome to your Income, <%= session.getAttribute("username") %></h2>
            <%@include file="msg.jsp" %>
        </header>
        <div class="container">
            <div class="create-income" id="createIncome">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="UpdateIncome?id=<%= rs.getString(1) %>" class="btn btn-sm btn-danger"><i class="fa-solid fa-trash"></i>Delete</a>
                    </td>
                </tr>
                <%
                        }
    ...
    <div class="modal" id="incomeModal">
        <div class="modal-content">
            ...
            <form method="POST" action="Income">
                <input type="text" name="name" id="name" placeholder="Income Name" required>
                <input type="number" name="amount" id="amount" placeholder="Amount" required>
                <input type="text" name="cat" id="cat" placeholder="Income Category" required>
    ...
    <script>
        const createIncomeBtn = document.getElementById('createIncome');
        const modal = document.getElementById('incomeModal');
        const closeModalBtn = document.getElementById('closeModal');

        createIncomeBtn.addEventListener('click', function() {
